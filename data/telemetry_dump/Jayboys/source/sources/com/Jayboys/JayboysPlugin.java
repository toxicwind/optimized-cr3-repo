...
public final class JayboysPlugin extends Plugin {
    public void load(@NotNull Context context) {
        registerMainAPI(new Jayboys1());
        registerMainAPI(new Jayboys2());
        registerExtractorAPI((ExtractorApi) new dsio());
        registerExtractorAPI(new VoeExtractor());
        registerExtractorAPI((ExtractorApi) new com.lagradost.cloudstream3.extractors.Voe());
        registerExtractorAPI((ExtractorApi) new boynextdoor());
        registerExtractorAPI((ExtractorApi) new crystal());
        registerExtractorAPI((ExtractorApi) new StreamTape());
        registerExtractorAPI(new yi069website());
        ...
        registerExtractorAPI((ExtractorApi) new tapepops());
        registerExtractorAPI((ExtractorApi) new FileMoon());
        registerExtractorAPI((ExtractorApi) new FilemoonV2());
        registerExtractorAPI(new Base64Extractor());
        registerExtractorAPI(new JP());
        registerExtractorAPI(new jaygo());
        registerExtractorAPI((ExtractorApi) new hypeboy());
        registerExtractorAPI((ExtractorApi) new do7go());
        registerExtractorAPI((ExtractorApi) new myvidplay());
    }
}
