...
public final class GayStreamProvider extends Plugin {
    public void load(@NotNull Context context) {
        registerMainAPI(new GayStream());
        ...
        registerExtractorAPI(new byseqekaho());
        registerExtractorAPI((ExtractorApi) new VidhideExtractor());
        registerExtractorAPI((ExtractorApi) new Space());
    }
}
