...
public final class GayxxProvider extends Plugin {
    public void load(@NotNull Context context) {
        ...
        registerExtractorAPI(new Bingezove());
        ...
        registerExtractorAPI(new AbyssExtractor());
        registerExtractorAPI(new GaybbExtractor());
    }
}
